        ...
        <nav className='flex items-center max-w-screen-xl mx-auto px-6 py-3 h-24'>
            ...
            {userLogged ? (
              <div className='flex items-center justify-end space-x-4'>
                ...
                <img src = "" alt = ""/>
                <p className='px-6 text-white hover:text-amber-100 hover:scale-105 transition duration-300'>Bem vindo, Nome!</p>
                <AiOutlineLogout className='w-6 h-6 cursor-pointer' onClick={logoutUser}/>
              </div>
            ) : (
